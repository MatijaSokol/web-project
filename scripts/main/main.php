...
<br> <br>
        ...
        <?php
                ...
                $products = $productDbHelper->findAll();
    ...
    <script>
        $(document).ready(function() {
            ...
            function getSearchedAds(query) {
                $.ajax({
                        method: "POST",
                        url: "getSearchedAds.php",
                        data: { query: query },
            ...
            function setQueriedElements(elements) {
                if (elements.length === 0) {
                    ...
                    for (let i = 0; i < elements.length; i++) {
                        ...
                        element += '<div class="text-center"> <button id="showMore" onclick="location.href=\'adDetails.php?id=' + elements[i].id.toString() + '\'" class="btn btn-primary">Show more</button> </div> </div> </div> </div>';
